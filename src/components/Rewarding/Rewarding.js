      ...
      <main className="rewarding__wrapper wrapper">
        ...
        <div className="rewarding__description">
          <h2 className="rewarding__title title general-title">
            ...
            Кыргызской Республики, поздравляет своих сотрудников с Днем независимости Кыргызстана.
          </h2>
          <p className="rewarding__text text">
            Сегодня, 30 августа, в Государственном учреждении "Автотранспортное предприятие" при Управлении делами Президента Кыргызской Республики
            состоялось торжественное мероприятие, В честь празднования 32-летия Независимости Кыргызстана. <br />
            С Днем независимости Кыргызстана, сотрудников Государственного учреждения "Автотранспортное предприятие" при Управлении делами Президента Кыргызской Республики
