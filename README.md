# ГУ "Автотранспортное предприятие при управлении делами президента Кыргызской республики" test

## Проект: ГУ "АТП УД КР"
* [Ссылка на проект](http://atp.gov.kg/)
* [Ссылка на проект на в gitHub](https://meder84.github.io/atp-frontend/)
